...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name        = "${var.project_name}-eks-public-subnet-${count.index + 1}"
    Environment = var.environment
    Project     = "ECS-to-EKS-Migration"
    Type        = "Public"
...
resource "aws_eip" "nat" {
  ...
  tags = {
    Name        = "${var.project_name}-eks-nat-eip-${count.index + 1}"
    Environment = var.environment
    Project     = "ECS-to-EKS-Migration"
  }
...
resource "aws_nat_gateway" "main" {
  ...
  tags = {
    Name        = "${var.project_name}-eks-nat-gateway-${count.index + 1}"
    Environment = var.environment
    Project     = "ECS-to-EKS-Migration"
  }
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name        = "${var.project_name}-eks-private-rt-${count.index + 1}"
    Environment = var.environment
    Project     = "ECS-to-EKS-Migration"
  }
}
